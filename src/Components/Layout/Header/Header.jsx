        ...
        <div>
          <ul id="navbar" className={clicked1 ? " #navbar active" : "#navbar"}>
            ...
            <li className="nav-links" id="our-product">
              <Link href="#" className="" onClick={handleClick1}>
                Our Product<span>+</span>
              </Link>
              <ul ref={menuRef} className="header-sub-menu">
                <li>
                  <Link to={"/acrylic"}>Acrylic And Plastics</Link>
                </li>
                <li>
                  <Link to={"/anatomy"}>Anatomy Models</Link>
                </li>
                <li>
                ...
                <li>
                  <Link to={"/leatherite"}>Leatherite</Link>
                </li>
                <li>
                  <Link to={"/metal"}>Metal</Link>
                </li>
                <li>
                  <Link to={"/sandtimers"}>Sand Timers</Link>
                </li>
                <li>
                  <Link to={"/shirtandtShirt"}>Shirts & T-Shirts</Link>
                </li>
                <li>
                  <Link to={"/umbrella"}>Umbrella</Link>
                </li>
                <li>
                  <Link to={"/spacepens"}>Space Pens</Link>
                </li>
              </ul>
            </li>
            <li className="nav-links">
