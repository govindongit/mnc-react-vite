        ...
        <div className="col-lg-3 col-md-6">
          <div className="footer__widget">
            <h2 className="footer__widget--title d-none d-md-block">
              About Us <button type="button" className="footer__widget--button" aria-label="footer widget button" />
            ...
            <div className="footer__widget--inner">
              <a className="footer__logo" href="index.aspx"><img className="footer__logo--img display-block" src="./src/assets/img/logo/m.png" alt="footer-logo" /></a>
