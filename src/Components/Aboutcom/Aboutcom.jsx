                    ...
                    <div className="row row-cols-lg-2 row-cols-md-2 row-cols-1 align-items-center">
                        <div className="col col-sm-order">
                            <div className="about__thumbnail" data-aos="fade-up">
                                <img className="display-block" src="./src/assets/img/myimage/about%20us.png" alt="about-thumb" />
                            </div>
                        </div>
                        <div className="col">
                    ...
                    <div className="row row-cols-lg-3 row-cols-1">
                        <div className="col">
                            <div className="featured__product--list">
                                <div className="featured__product--card mb-30 aos-init aos-animate" data-aos="fade-up">
                                    <div className="featured__product--card__icon--img">
                                        <span className="featured__product--card__icon">
                                            <img className="display-block" src="./src/assets/img/myimage/icon/mission.png" alt="setting-icon" />
                                        </span>
                                    </div>
                                ...
                                <div className="featured__product--card aos-init" data-aos="fade-up">
                                    <div className="featured__product--card__icon--img">
                                        <span className="featured__product--card__icon">
                                            <img className="display-block" src="./src/assets/img/myimage/icon/vision.png" alt="setting-icon" />
                                        </span>
                                    </div>
                                    <div className="featured__product--card__content">
                        ...
                        <div className="col">
                            <div className="featured__product--thumbnail">
                                <img className="featured__product--thumbnail__img display-block" src="./src/assets/img/myimage/Pennnn32.png" alt="featured-img" />
                            </div>
                        </div>
                        <div className="col">
                            <div className="featured__product--list">
                                <div className="featured__product--card mb-30 aos-init aos-animate" data-aos="fade-up">
                                    <div className="featured__product--card__icon--img">
                                        <span className="featured__product--card__icon">
                                            <img className="display-block" src="./src/assets/img/myimage/icon/value-proposition.png" alt="setting-icon" />
                                        </span>
                                    </div>
                                    <div className="featured__product--card__content">
                                ...
                                <div className="featured__product--card aos-init" data-aos="fade-up">
                                    <div className="featured__product--card__icon--img">
                                        <span className="featured__product--card__icon">
                                            <img className="display-block" src="./src/assets/img/icon/setting-icon.png" alt="setting-icon" />
                                        </span>
                                    </div>
                                    <div className="featured__product--card__content">
